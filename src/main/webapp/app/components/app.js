System.register(['angular2/core', 'angular2/router', "./organisations/organisations.component", "./register.component", "./home", "./loggedInHome.component", "./ThemeComponent", "./kandoeCard", "./userprofile.component", "./organisations/addOrganisation.component"], function(exports_1) {
    ...
    var core_1, router_1, organisations_component_1, register_component_1, home_1, loggedInHome_component_1, ThemeComponent_1, kandoeCard_1, userprofile_component_1, addOrganisation_component_1;
    var AppComponent;
    return {
        setters:[
            function (core_1_1) {
